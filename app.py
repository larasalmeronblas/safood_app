...
tab1, tab2 = st.tabs(["➕ Cargar ingredientes", "🍽️ Recetas"])
...
# TAB 2: Recetas con subpestañas
with tab2:
    tab_crear, tab_analizar = st.tabs(["🧪 Crear receta", "📊 Analizar receta"])
    ...
    with tab_analizar:
        ...
        if not receta_df.empty:
            ...
            if peso_total > 0:
                ...
                st.warning("⚠️ La receta no tiene cantidades asignadas.")
